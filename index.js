...
const displayCategories = category => {
  ...
  category.forEach(category => {
    ...
    categoryList.innerHTML = `
        <li class="nav-item p-4 bg-primary text-white">
        <button  class=" btn btn-outline-warning px-1 py-2 border-0 nav-link fw-bold fs-5" href="#" onclick ="loadNews('${category.category_id}')">
